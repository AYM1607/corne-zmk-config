...
This is a WIP layout based on Colemak DHm for using on Windows (with **en-US** layout), taking in mind some Spanish accents, easy access to development symbols and JS/TS shortcuts.
